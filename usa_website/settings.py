"""
Django settings for usa_website project.
...
ALLOWED_HOSTS = ['susa-berkeley-edu.apphost.ocf.berkeley.edu', "127.0.0.1"]
...
WSGI_APPLICATION = 'usa_website.wsgi.application'
