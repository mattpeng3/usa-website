...
urlpatterns = [
    ...
    url(r'blog/a-shallow-dive-into-time-series-analysis-of-local-restaurant-data-using-r', views.shallow_dive, name="shallow_dive"),
    ...
    url(r'blog/website-tutorial-0$', views.website_tutorial_0, name="website_tutorial_0"),
